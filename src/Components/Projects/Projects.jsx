...
const Projects = () => {
  ...
  const themeClasses = {
    section: isDarkMode
      ? "bg-gradient-to-br from-[#0a192f] to-[#1e293b] text-white"
      : "bg-gradient-to-br from-[#f8fafc] to-[#e2e8f0] text-slate-900",
    input: isDarkMode
      ? "bg-white/10 text-white placeholder-blue-200"
      : "bg-slate-200 text-slate-900 placeholder-slate-500",
    ...
    passwordCard: isDarkMode ? "bg-white/10" : "bg-slate-100",
    showMoreButton: isDarkMode
  ...
  return (
    <section
      id="projects"
      className={`py-20 min-h-screen transition-colors duration-300 ${themeClasses.section}`}
    >
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
          ...
          <button
            onClick={toggleTheme}
            className={`p-3 rounded-lg transition-all shadow-lg ${isDarkMode ? "bg-slate-900 text-yellow-300" : "bg-slate-200 text-slate-900 hover:bg-slate-300"}`}
            title="Toggle theme"
          >
            {isDarkMode ? (
        ...
        <div className="flex justify-center mb-6">
          <div className="relative w-full max-w-md">
            ...
            />
            <FaSearch
              className={`absolute top-3 right-4 ${isDarkMode ? "text-blue-300" : "text-slate-500"}`}
            />
          </div>
        </div>
          ...
          {displayedProjects.map((project) => (
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-between p-6">
                <div>
                  <h3
                    className={`text-lg font-semibold mb-1 ${themeClasses.cardText}`}
                  >
                    {project.title}
                  </h3>
