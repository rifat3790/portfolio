...
const About = () => {
  ...
  return (
    <section
      id="about"
      className={`relative py-20 flex items-center justify-center overflow-hidden transition-colors duration-500 ${
        isDarkMode
    ...
    >
      ...
      <div className="container mx-auto px-6 max-w-screen-xl">
        <div className="flex flex-col lg:flex-row gap-12 items-stretch justify-center">
          <div className="flex-1 h-full space-y-6 section-card rounded-2xl p-8 animate-fadeInUp">
            ...
            <p className="text-lg text-blue-200 text-center font-medium mb-6 animate-fadeIn">
              ...
              <span className="font-bold text-blue-400">2+ years</span> of
            ...
            <div className="space-y-4 text-base text-slate-200 leading-relaxed font-medium">
              <p>
                Passionate and detail-focused Full Stack Developer with
                experience in developing responsive and interactive web
                applications using{" "}
              ...
              <p>
                ...
                <span className="text-blue-300 font-semibold">MySQL</span>, and
                implementing secure authentication systems with{" "}
                <span className="text-blue-400 font-semibold">bcrypt</span>.
              </p>
              <p>
                Quick to learn new technologies and committed to continuous
                skill development. Currently pursuing{" "}
                <span className="text-blue-400 font-semibold">
                  B.Sc. in Computer Science
                </span>{" "}
                at Green University of Bangladesh with a CGPA of{" "}
                <span className="text-purple-400 font-semibold">3.75</span>.
              </p>
            </div>
          ...
          <div className="flex-1 flex flex-col gap-8">
            <div className="section-card rounded-2xl p-8 animate-fadeInRight">
